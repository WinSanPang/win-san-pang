        ...
        <section className={classes.openBook}>
          ...
          <article>
            ...
            <p>
              ...
              of a <span className={classes.openBookBlue}>bookworm</span> and became particularly interested in studying the <span className={classes.openBookYellow}>English Language</span> and how language worked.
            </p>
            <p>
              It wasn't until I started working
              at <span className={classes.openBookGreen}>JustPark</span> that I developed an interest in <span className={classes.openBookOrange}>programming languages</span>. In my teenage years, I dismissed coding as being too "Science-y / Maths-y" for me, but little did I know how much I would come to love it years later.
            </p>
            ...
            <ul>
              <li>BA English Language & Communication: First-class honours (76%)</li>
            </ul>
            ...
            <ul>
              <li>
                The Open University: Start Writing Fiction module, OU Level 1, 10
                credits (Pass)
              </li>
            </ul>
